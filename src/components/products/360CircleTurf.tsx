...
<div className="">
  <div className="bg-background relative z-10 select-none">
    ...
    <Container className="relative z-10 space-y-12 py-36 text-3xl font-bold text-white md:text-4xl">
      ...
      <FadeIn>
        <span>
          Establishing modern basketball courts in urban and suburban areas is
          a significant opportunity as interest in basketball continues to
          grow. With a rise in community sports initiatives, schools, and local
          organizations seeking quality courts, there’s an increasing demand
          for spaces designed to enhance performance and safety. Investing in
          professional-grade courts not only meets the need for durable playing
          surfaces but also ensures minimal maintenance and maximized
          usability. Advanced synthetic surfaces offer improved grip,
          resistance to wear, and safer gameplay while allowing multi-sport
          adaptability.
        </span>
      </FadeIn>
    </Container>
  </div>
  <VideoCarousel title="Basketball Court & Turf" carouselImages={basketballAndTurfItems} />
  <AnimateCard>
    <Certificates />
  </AnimateCard>
  ...
  <div className="flex gap-10 lg:flex-row flex-col px-10 md:px-20 lg:px-[7.5rem] py-20">
    <div className="w-full flex flex-col justify-center items-start gap-8">
      <AnimateCard>
        <p className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-primary text-white uppercase leading-tight">
          360° CIRCLE TURF <span className="text-secondary">FOR MULTI-USE</span>
        </p>
      </AnimateCard>
