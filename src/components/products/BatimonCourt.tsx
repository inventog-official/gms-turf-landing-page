    ...
    <Container className="relative z-10 space-y-12 py-36 text-3xl font-bold text-white md:text-4xl">
      ...
      <FadeIn>
        <span>
          ...
          offers a remarkable business opportunity. With communities focusing
          on sports and fitness, the demand for high-quality badminton courts
          is growing. Opting for synthetic flooring ensures enhanced safety and
          durability, minimizing the risk of injuries while improving the
          playing experience. These courts not only provide a flat and
          standardized playing surface but also include protective features
          like proper lighting and boundary markers to elevate the overall
          game quality.
        </span>
      </FadeIn>
    </Container>
